...
export default class Arena extends React.Component {
  ...
  human(){
    return <Human maxHp={this.state.p1MaxHp} hp={this.state.p1Hp} attk={this.state.p1Atk} ac={this.state.p1Ac} hit={this.state.p2Hit}></Human>
  }

  monster(){
    return <Monster maxHp={this.state.p2MaxHp} hp={this.state.p2Hp} attk={this.state.p2Atk} ac={this.state.p2Ac} hit={this.state.p2Hit}></Monster>
  }
